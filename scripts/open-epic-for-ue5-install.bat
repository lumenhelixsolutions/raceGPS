...
chcp 65001 >nul
echo ========================================
echo   raceGPS UE 5.7 Installer Helper
echo ========================================
echo.
...
echo STEP 4: Select 5.7.x (latest)
echo STEP 5: Click INSTALL
echo STEP 6: Choose install location: D:\Epic Games\UE_5.7
...
echo When UE 5.7 is installed, run:
