...
TMap<EMasterMaterialType, TSoftObjectPtr<UMaterialInterface>> URaceGPSMaterialProvider::MaterialCache;
TMap<EMasterMaterialType, UMaterialInterface*> URaceGPSMaterialProvider::MaterialOverrides;
bool URaceGPSMaterialProvider::bCacheInitialized = false;

void URaceGPSMaterialProvider::InitializeCache()
{
...
UMaterialInterface* URaceGPSMaterialProvider::GetMasterMaterial(EMasterMaterialType Type)
{
    InitializeCache();
...
UMaterialInterface* URaceGPSMaterialProvider::GetDefaultMaterial()
{
    return UMaterial::GetDefaultMaterial(MD_Surface);
}

UMaterialInstanceDynamic* URaceGPSMaterialProvider::CreateMaterialInstance(EMasterMaterialType Type, UObject* Outer)
{
...
void URaceGPSMaterialProvider::PreloadMaterialAsync(EMasterMaterialType Type)
{
    InitializeCache();
    if (TSoftObjectPtr<UMaterialInterface>* Cached = MaterialCache.Find(Type))
    {
...
FString URaceGPSMaterialProvider::GetMaterialPath(EMasterMaterialType Type)
{
    InitializeCache();
    if (TSoftObjectPtr<UMaterialInterface>* Cached = MaterialCache.Find(Type))
    {
...
bool URaceGPSMaterialProvider::IsMaterialAvailable(EMasterMaterialType Type)
{
    InitializeCache();
...
void URaceGPSMaterialProvider::RegisterMaterialOverride(EMasterMaterialType Type, UMaterialInterface* Override)
{
    if (Override)
    {
