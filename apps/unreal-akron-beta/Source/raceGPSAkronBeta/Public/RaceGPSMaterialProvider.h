...
#include "RaceGPSMaterialProvider.generated.h"
 ...
 */
UCLASS()
class RACEGPSAKRONBETA_API URaceGPSMaterialProvider : public UObject
{
    GENERATED_BODY()

public:
    UFUNCTION(BlueprintPure, Category = "RaceGPSMaterialProvider")
    static UMaterialInterface* GetMasterMaterial(EMasterMaterialType Type);

    UFUNCTION(BlueprintPure, Category = "RaceGPSMaterialProvider")
    static UMaterialInterface* GetDefaultMaterial();

    UFUNCTION(BlueprintCallable, Category = "RaceGPSMaterialProvider")
